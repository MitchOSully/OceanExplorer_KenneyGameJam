...
namespace TarodevController {
    ...
    /// </summary>
    public class PlayerControllerWater : MonoBehaviour, IPlayerController {
        ...
        private void Update() {
            ...
            CalculatePaddle(); // Horizontal and vertical movement
        ...
        [Header("PADDLE")] [SerializeField] private float _acceleration = 90;
        [SerializeField] private float _moveClamp = 13;
        [SerializeField] private float _deAcceleration = 60f;
        [SerializeField] private float _apexBonus = 2;

        private void CalculatePaddle() 
        {
            CalculateXPaddle();
            CalculateYPaddle();
        }

        private void CalculateXPaddle()
        {
            if (Input.X != 0) {
